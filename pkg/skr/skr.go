...
func SecureKeyRelease(identity common.Identity, certCache attest.CertCache, SKRKeyBlob KeyBlob, uvmInformation common.UvmInformation) (_ jwk.Key, err error) {
	...
	// Attest
	maaToken, err = attest.Attest(certCache, SKRKeyBlob.Authority, jwkSetBytes, uvmInformation)
	if err != nil {
