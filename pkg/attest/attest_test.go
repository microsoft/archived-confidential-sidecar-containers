...
func Test_VCEK(t *testing.T) {
	validUrl, err := url.Parse("https://americas.test.acccache.azure.net/vcek/v1/")
	var invalidUrl *url.URL
	invalidUrl, err = url.Parse("https://americas.test.accache.azure.net")
	TestValidUvmInformation := common.UvmInformation{
		EncodedSecurityPolicy:   "", // irrelevant for this test
		CertChain:               "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n",
		EncodedUvmReferenceInfo: "",       // irrelevant for this test
		RemoteTHIMServiceURL:    validUrl, // TO-DO: add test for getting URL from env var?
	}

	TestInvalidUrlUvmInformation := common.UvmInformation{
		EncodedSecurityPolicy:   "", // irrelevant for this test
		CertChain:               "",
		EncodedUvmReferenceInfo: "", // irrelevant for this test
		RemoteTHIMServiceURL:    invalidUrl,
	}

	TestInvalidCertChainUvmInformation := common.UvmInformation{
		EncodedSecurityPolicy:   "", // irrelevant for this test
		CertChain:               "",
		EncodedUvmReferenceInfo: "", // irrelevant for this test
		RemoteTHIMServiceURL:    invalidUrl,
	...
	expectedUrl, err = url.Parse("https://americas.test.acccache.azure.net/vcek/v1/Milan-A0/e6c86796cd44b0bc6b7c0d4fdab33e2807e14b5fc4538b3750921169d97bcf4447c7d3ab2a7c25f74c1641e2885c1011d025cc536f5c9a2504713136c7877f48?ucodeSPL=49&snpSPL=0&teeSPL=0&blSPL=0")
	testcases := []*testcase{
		// ParseVcek_Success passes the testing if the error returned is nil and the returned content matches the expected one
		{
			name: "ParseVcek_Success",

			UvmInformation: &TestValidUvmInformation,

			expectedTcb: 3530822107858468864,
			expectedUrl: expectedUrl,

			expectedError: nil,
			expectErr:     false,
		},
		// ParseVcek_InvalidTHIMServiceURL passes the testing if it receives the expected error
		{
			name: "ParseVcek_InvalidTHIMServiceURL",

			UvmInformation: &TestInvalidUrlUvmInformation,

			expectedError: errors.Errorf("No UVM certificate chain found"),
			expectErr:     true,
		},
		// ParseVcek_InvalidCertChain passes the testing if it receives the expected error
		{
			name: "ParseVcek_InvalidCertChain",

			UvmInformation: &TestInvalidCertChainUvmInformation,
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			var tcbValue uint64
			tcbValue, err = tc.UvmInformation.ParseVCEK()
			...
			if tc.expectErr {
				...
				if err != nil {
					t.Fatalf("did not expect err got %q", err.Error())
				} else if tcbValue != tc.expectedTcb {
					t.Fatalf("expected %d got %d", tc.expectedTcb, tcbValue)
				} else if strings.Compare(tc.expectedUrl.String(), tc.UvmInformation.RemoteTHIMServiceURL.String()) == 0 {
					t.Fatalf("expected %s got %s", tc.expectedUrl, tc.UvmInformation.RemoteTHIMServiceURL)
				}
			}
		})
	}
