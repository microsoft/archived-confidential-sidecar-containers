...
func Test_VCEK(t *testing.T) {
	TestValidUvmInformation := common.UvmInformation{
		...
		RemoteTHIMServiceURL:    "https://americas.test.acccache.azure.net/vcek/v1/", // TO-DO: add test for getting URL from env var?
	}
	...
	TestInvalidUrlUvmInformation := common.UvmInformation{
		...
		CertChain:               "",
		EncodedUvmReferenceInfo: "", // irrelevant for this test
		RemoteTHIMServiceURL:    "https://americas.test.accache.azure.net",
	}
	...
	TestInvalidCertChainUvmInformation := common.UvmInformation{
		...
		CertChain:               "",
		EncodedUvmReferenceInfo: "", // irrelevant for this test
		RemoteTHIMServiceURL:    "https://americas.test.acccache.azure.net",
	}
	...
	testcases := []*testcase{
		// ParseVcek_Success passes the testing if the error returned is nil and the returned content matches the expected one
		{
			...
			expectedUrl: "https://americas.test.acccache.azure.net/vcek/v1/Milan-A0/e6c86796cd44b0bc6b7c0d4fdab33e2807e14b5fc4538b3750921169d97bcf4447c7d3ab2a7c25f74c1641e2885c1011d025cc536f5c9a2504713136c7877f48?ucodeSPL=49&snpSPL=0&teeSPL=0&blSPL=0",
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.expectErr {
				...
				} else if strings.Compare(tc.expectedUrl, tc.UvmInformation.RemoteTHIMServiceURL) == 0 {
